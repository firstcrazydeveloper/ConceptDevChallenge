...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            imports: [
                platform_browser_1.BrowserModule, animations_1.BrowserAnimationsModule, common_1.CommonModule, forms_1.FormsModule, forms_2.ReactiveFormsModule, ng_bootstrap_1.NgbModule.forRoot(), app_routing_1.routing, shared_module_1.SharedModule.forRoot()
            ],
            providers: [],
