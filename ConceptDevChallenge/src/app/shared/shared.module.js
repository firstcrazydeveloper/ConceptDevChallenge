...
var sidemenu_service_1 = require("./components/sidemenu/sidemenu.service");
...
var SharedModule = (function () {
    ...
    SharedModule = SharedModule_1 = __decorate([
        core_1.NgModule({
            ...
            providers: [webApiManager_service_1.WebApiManager, navmenu_service_1.NavMenuService, busyspinner_service_1.BusySpinnerService, mail_service_1.MailService, sidemenu_service_1.SideMenuService]
        })
    ], SharedModule);
    return SharedModule;
    var SharedModule_1;
