...
var busyspinner_service_1 = require("./busyspinner.service");
var BusySpinnerComponent = (function () {
    ...
    BusySpinnerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [busyspinner_service_1.BusySpinnerService])
    ], BusySpinnerComponent);
    return BusySpinnerComponent;
}());
exports.BusySpinnerComponent = BusySpinnerComponent;
