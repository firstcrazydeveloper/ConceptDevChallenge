...
var VolumeInfo = (function () {
    function VolumeInfo() {
    }
    return VolumeInfo;
}());
exports.VolumeInfo = VolumeInfo;
var IndustryIdentifier = (function () {
    function IndustryIdentifier() {
    }
    return IndustryIdentifier;
}());
exports.IndustryIdentifier = IndustryIdentifier;
var ReadingModes = (function () {
    function ReadingModes() {
    }
    return ReadingModes;
}());
exports.ReadingModes = ReadingModes;
var PanelizationSummary = (function () {
    function PanelizationSummary() {
    }
    return PanelizationSummary;
}());
exports.PanelizationSummary = PanelizationSummary;
...
//# sourceMappingURL=volumeInfo.model.js.map